                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Students.index') }}" target="_blank"><span
                                        class="text-danger">{{ trans('main_trans.Display_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('My_Classes_trans.Number_of_classes') }}
                                    </p>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="teachers-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false">{{ trans('Teacher_trans.Teachers') }}
                                                </a>
                                            </li>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="parents-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false">{{ trans('Parent_trans.Parents') }}
                                                </a>
                                            </li>
