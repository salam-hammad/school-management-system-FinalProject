<div>
    ...
    @else
        <div class="stepwizard">
            <div
                class="stepwizard-row setup-panel d-flex justify-content-around align-items-center position-relative mb-4">
                <!-- الخط -->
                <div class="line position-absolute w-100"
                    style="top: 30%; left: 0; right: 0; height: 2px; background-color: #f2ecec; z-index: 0;"></div>

                <!-- المربعات -->
                <div class="stepwizard-step" style="position: relative; z-index: 1;">
