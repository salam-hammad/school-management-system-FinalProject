...
@section('css')
    @toastr_css
@section('title')
{{trans('Students_trans.Edit_Tuition_fee_processors')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
      {{trans('Students_trans.Edit_Tuition_fee_processors')}}   : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
